...
export function LoopFlow() {
  ...
  const artefacts = [
    { file: 'spec.md', key: 'spec' as const },
    { file: 'plan.md', key: 'plan' as const },
    { file: 'tasks.md', key: 'tasks' as const },
  ]

  return (
    <section className="skl-section" aria-label={t('kicker')}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="skl-section__head">
